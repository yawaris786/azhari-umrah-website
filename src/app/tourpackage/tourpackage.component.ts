...
export class TourpackageComponent {
  ...
  get_package(umrah_types:any) {
    ...
    let url = this.GET_PACKAGE+'?umrah_type='+umrah_types+'&page='+this.current_page;
